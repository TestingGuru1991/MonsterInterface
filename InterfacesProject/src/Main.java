...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Player petar = new Player("Petar", 10, 15);
        System.out.println(petar.toString());
        saveObject(petar);

        petar.setHitPoints(8);
        System.out.println(petar);
        petar.setWeapon("Stormbringer");
        saveObject(petar);
//        loadObject(petar);
        System.out.println(petar);
        ...
        //ili Monster wereWolf = new Monster("Werewolf", 20, 40);
        //onda moze: wereWolf.getStrength();
